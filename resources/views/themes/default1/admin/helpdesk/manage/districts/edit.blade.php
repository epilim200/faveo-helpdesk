...
<!-- content -->
@section('content')
{!! Form::model($district,['url' => 'districts/'.$district->id, 'method' => 'PATCH']) !!}
...
<div class="alert alert-danger alert-dismissable">
    ...
    <li class="error-message-padding">{!! $errors->first('state_id', ':message') !!}</li>
    @endif
</div>
@endif
<div class="card card-light">
    <div class="card-header">
        <h3 class="card-title">Kemaskini Daerah</h3>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('state_id') ? 'has-error' : '' }}">
                    {!! Form::label('state_id','Negeri') !!} <span class="text-red"> *</span>
                    {!! Form::select('state_id', $states, null, ['class' => 'form-control', 'placeholder' => '-- Pilih Negeri --']) !!}
                </div>
            </div>
        </div>
    </div>
