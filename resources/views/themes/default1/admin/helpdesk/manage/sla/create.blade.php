        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('grace_period') ? 'has-error' : '' }}">
                    ...
                    {!! Form::select('grace_period',['3 Hours'=>'3 Hours','6 Hours'=>'6 Hours', '12 Hours'=>'12 Hours', '18 Hours'=>'18 Hours', '24 Hours'=>'24 Hours', '36 Hours'=>'36 Hours', '48 Hours'=>'48 Hours', '72 Hours'=>'72 Hours'],null,['class' => 'form-control']) !!}
                </div>
            </div>
